...
const web3              = new WebProvider().getInstance().web3;
const web3Network       ="ganache";
let myContractInstance  = require('../config/contract');
const circularJSON      = require('circular-json');
const pathMetadata      = '/../utils/metadata.js';
const { info, 
        blue,
...
const deploy = async () => {
    ...
    try {
        ...
        let bytecode = '0x' + simpleStorage.evm.bytecode.object;
